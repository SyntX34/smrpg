...
public void OnLibraryAdded(const char[] name)
{
	...
	if(StrEqual(name, "smrpg"))
	{
		...
		g_hCVColorT = SMRPG_CreateUpgradeConVar(UPGRADE_SHORTNAME, "smrpg_poisonsmoke_color_t", "0", "What color should the smoke be for grenades thrown by terrorists? Format: \"red green blue\" from 0 - 255.");
		g_hCVColorCT = SMRPG_CreateUpgradeConVar(UPGRADE_SHORTNAME, "smrpg_poisonsmoke_color_ct", "0", "What color should the smoke be for grenades thrown by counter-terrorists? Format: \"red green blue\" from 0 - 255.");
